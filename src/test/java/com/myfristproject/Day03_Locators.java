...
//        (USE getText() method to get the text from the page)
       ...
       // Alternatively;
       // But this low code is not so clear, so we should write understandable codes.
      ...
      // Sign Out texts are displayed
       ...
       // driver.findElement(By.partialLinkText("Adres"));
       ...
       // if user sign out successfully, it means the url is sign in url: https://a.testadressbook.com/sign_in
       boolean isSignedOUt = driver.getCurrentUrl().equals("https://a.testadressbook.com/sign_in");
        ...
        *
        * When is partialLinkText usefull?
