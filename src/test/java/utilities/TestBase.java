...
public abstract class TestBase {
 ...
 public void setup() {
  ...
  //Report Path = creates the html report right under test-output folder
  ...
  extentTest = extentReports.createTest
          ("My Project Extent Report", "This is for smoke test report");
...
//        System.out.println(currentDate);
 ...
 public void getValueByJS(String idOfElement){
  ...
  // For example, I can get the element by id, and use value attribute to get the value of an input
